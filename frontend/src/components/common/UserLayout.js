...
import { Home, ShoppingBag, Package, CalendarCheck, User, LogOut, ShoppingCart, Menu, X, Wallet, Bell, ChevronRight } from 'lucide-react';
import { useState } from 'react';
import './UserLayout.css';

/* D5 Logo SVG */
const D5Logo = ({ size = 36 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="100" height="100" rx="16" fill="#2E1A3C"/>
    <path d="M18 15 L18 85 L45 85 C68 85 82 70 82 50 C82 30 68 15 45 15 Z" fill="white"/>
    <circle cx="50" cy="50" r="22" fill="#2E1A3C"/>
    <circle cx="50" cy="50" r="17" stroke="white" strokeWidth="2.5" fill="none"/>
    <text x="50" y="57" textAnchor="middle" fill="white" fontSize="18" fontWeight="bold" fontFamily="serif">5</text>
  </svg>
);
