...
const customerDetailsSchema = new mongoose.Schema({
  name:               { type: String },
  email:              { type: String },
  phone:              { type: String, default: '' },   // NOT required
...
const orderSchema = new mongoose.Schema(
  {
    ...
    orderType:   { type: String, required: true, enum: ['grocery','housekeeping','maintenance','utility','spa_wellness'] },
    ...
    statusHistory:    [{ status: String, updatedAt: { type: Date, default: Date.now }, note: String, updatedBy: String }],

    // Payment
    paymentStatus: { type: String, enum: ['pending','paid','failed','refunded','wallet','simulated'], default: 'pending' },
    paymentMethod: { type: String, enum: ['card','wallet','cash_on_delivery','simulated','razorpay'], default: 'cash_on_delivery' },
    paymentSimulation: { cardLast4: String, cardHolder: String, transactionId: String, paidAt: Date },
    ...
    staffProofNote:    { type: String, default: '' },
